...
interface ThirdConsoleProps {
    setSelectedRoad: React.Dispatch<React.SetStateAction<string>>;
    selectedRoad: string;
    setSelectedTime: React.Dispatch<React.SetStateAction<string>>;
    selectedTime: string;
}
const ThirdConsole: React.FC<ThirdConsoleProps> = ({ setSelectedRoad, selectedRoad, setSelectedTime, selectedTime }) => {
