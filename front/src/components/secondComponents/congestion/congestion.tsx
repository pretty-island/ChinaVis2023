...
const CongestionParallel: React.FC = () => {
    ...
    useEffect(() => {
        if (chartRef.current !== null) {
            ...
            const schema = [
              ...
              { name: 'cong', index: 1, text: '' },
              { name: 'road', index: 2, text: '' },
              { name: 'flow', index: 3, text: '' },
              { name: 'nixing', index: 4, text: ' ' },
              { name: 'overspeed', index: 5, text: '' },
              { name: 'stop', index: 6, text: '' },
              { name: 'health', index: 7, text: '' },
              { name: '等级', index: 8, text: '' }
            ];
            const lineStyle = {
              width: 1,
              opacity: 0.5
