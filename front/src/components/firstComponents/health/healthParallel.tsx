        ...
        if (chartRef.current !== null) {
            ...
            const dataBJ = [
              ...
              const schema = [
                ...
                { name: 'cong', index: 1, text: '拥堵指数' },
                { name: 'road', index: 2, text: '道路占有率' },
                { name: 'flow', index: 3, text: '交通流量' },
                { name: 'nixing', index: 4, text: ' 逆行事件' },
                { name: 'overspeed', index: 5, text: '超速事件' },
                { name: 'stop', index: 6, text: '长时间停车' },
                { name: 'health', index: 7, text: '道路健康度' },
